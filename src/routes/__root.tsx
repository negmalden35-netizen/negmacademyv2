...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "نجم | منصة إدارة السناتر والمعلمين" },
      {
        name: "description",
        content: "منصة نجم لإدارة السناتر والمعلمين والطلاب: مجموعات وحضور ومدفوعات واختبارات تفاعلية.",
      },
      { property: "og:title", content: "نجم | منصة إدارة السناتر والمعلمين" },
      {
        property: "og:description",
        content: "منصة نجم لإدارة السناتر والمعلمين والطلاب.",
      },
...
function RootComponent() {
  ...
  useEffect(() => {
    if (localStorage.getItem("negm-theme") === "dark") {
